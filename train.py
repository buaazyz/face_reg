    ...
    def train(self, conf, epochs):
        ...
        for e in range(epochs):
            ...
            for imgs, labels in tqdm(iter(self.loader)):
                ...
                embeddings = self.model(imgs)
                thetas = self.head(embeddings, labels)
                # print(thetas,type(thetas),thetas.shape)
                loss = conf.ce_loss(thetas, labels)
                # print(loss)
                # exit()
                loss.backward()
                ...
                #     accuracy, best_threshold, roc_curve_tensor = self.evaluate(conf, self.essex,
                #                                                                self.essex_issame)
                    # self.board_val('essex', accuracy, best_threshold, roc_curve_tensor)
